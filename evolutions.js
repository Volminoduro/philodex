...
"002": { debut:1729, fin:1776, learn:[11,11,12], stages:[
  ...
  { lvl:11, types:["Empirisme","Scepticisme"], img:null,
    fr:{nom:"L'AUTEUR DU TRAITÉ", note:"Le Traité tombe mort-né de la presse ; la causalité y est déjà réduite à une habitude."},
    en:{nom:"AUTHOR OF THE TREATISE", note:"The Treatise falls dead-born from the press; causality is already reduced to habit."} },
...
"004": { debut:68, fin:135, approx:true, learn:[26,30,41], stages:[
  ...
  { lvl:26, types:["Stoïcisme"], img:null,
    fr:{nom:"LE MAÎTRE DE NICOPOLIS", note:"Chassé d'Italie par Domitien, il ouvre son école et enseigne ce qui dépend de nous."},
    en:{nom:"MASTER OF NICOPOLIS", note:"Expelled from Italy by Domitian, he opens his school and teaches what is up to us."} },
...
"005": { debut:-450, fin:-399, approx:true, learn:[26,26,21], stages:[
  ...
  { lvl:21, types:["Dialectique"], img:null,
    fr:{nom:"L'ÉNIGME DE DELPHES", note:"L'oracle le dit le plus sage ; il en conclut qu'il sait seulement qu'il ne sait rien."},
    en:{nom:"THE DELPHIC RIDDLE", note:"The oracle calls him wisest; he concludes he knows only that he knows nothing."} },
...
"008": { debut:-327, fin:-270, approx:true, learn:[22,28,17], stages:[
  ...
  { lvl:17, types:["Épicurisme","Matérialisme"], img:null,
    fr:{nom:"LE MAÎTRE DE LAMPSAQUE", note:"Premières écoles à Mytilène puis Lampsaque : les atomes servent désormais à guérir la peur."},
    en:{nom:"MASTER OF LAMPSACUS", note:"First schools at Mytilene then Lampsacus: atoms now serve to cure fear."} },
...
"009": { debut:-384, fin:-323, approx:true, learn:[21,15,30], stages:[
  ...
  { lvl:15, types:["Cynisme"], img:null,
    fr:{nom:"LE CHIEN D'ATHÈNES", note:"Antisthène le chasse à coups de bâton ; il reste. L'autarcie s'apprend en ne possédant rien."},
    en:{nom:"THE DOG OF ATHENS", note:"Antisthenes beats him away with a stick; he stays. Self-sufficiency is learned by owning nothing."} },
...
"011": { debut:1245, fin:1274, learn:[21,15,27], stages:[
  ...
  { lvl:15, types:["Philo. Religion","Logique"], img:null,
    fr:{nom:"LE DOCTEUR DES GENTILS", note:"La Somme contre les Gentils tente de parler à qui ne partage pas la Révélation."},
    en:{nom:"DOCTOR OF THE GENTILES", note:"The Summa contra Gentiles attempts to address those who share no Revelation."} },
...
"013": { debut:1652, fin:1704, learn:[20,29,39], stages:[
  ...
  { lvl:20, types:["Empirisme"], img:null,
    fr:{nom:"LE MÉDECIN DE SHAFTESBURY", note:"Une soirée entre amis lance l'Essai : l'esprit n'a rien avant l'expérience."},
    en:{nom:"SHAFTESBURY'S PHYSICIAN", note:"An evening among friends launches the Essay: the mind holds nothing before experience."} },
...
"015": { debut:1749, fin:1778, learn:[14,14,7], stages:[
  ...
  { lvl:7,  types:["Contractualisme"], img:null,
    fr:{nom:"LE PROMENEUR SAUVAGE", note:"Le second Discours remonte avant l'histoire : l'inégalité n'est pas de nature, elle est instituée."},
    en:{nom:"THE SAVAGE WALKER", note:"The second Discourse goes back before history: inequality is not natural but instituted."} },
...
"025": { debut:-604, fin:-546, approx:true, learn:[30,40,20], stages:[
  ...
  { lvl:20, types:["Matérialisme"], img:null,
    fr:{nom:"L'ASTRONOME", note:"L'éclipse de 585 arrive comme il l'avait dit : le ciel cesse d'être un présage."},
    en:{nom:"THE ASTRONOMER", note:"The eclipse of 585 arrives as he foretold: the sky ceases to be an omen."} },
...
"026": { debut:-590, fin:-546, approx:true, learn:[16,26,36], stages:[
  ...
  { lvl:16, types:["Matérialisme"], img:null,
    fr:{nom:"LE CARTOGRAPHE", note:"Première carte du monde, premier gnomon : la Terre flotte sans support, retenue par la symétrie."},
    en:{nom:"THE MAPMAKER", note:"The first world map, the first gnomon: the Earth floats unsupported, held by symmetry."} },
...
"027": { debut:-565, fin:-528, approx:true, learn:[11,21,31], stages:[
  { lvl:1,  types:["Matérialisme"], img:null,
    fr:{nom:"L'ÉLÈVE D'ANAXIMANDRE", note:"Troisième Milésien, il juge l'illimité de son maître trop vague pour expliquer quoi que ce soit."},
    en:{nom:"ANAXIMANDER'S PUPIL", note:"The third Milesian, he finds his master's boundless too vague to explain anything."} },
  { lvl:11, types:["Matérialisme"], img:null,
    fr:{nom:"LE SOUFFLE DU MONDE", note:"L'air : assez indéterminé pour tout produire, assez concret pour être observé."},
    en:{nom:"THE WORLD'S BREATH", note:"Air: indeterminate enough to yield everything, concrete enough to be observed."} },
  { lvl:31, types:["Matérialisme"], img:null,
...
"028": { debut:-550, fin:-497, approx:true, learn:[21,26,31], stages:[
  ...
  { lvl:21, types:["Rationalisme","Mysticisme"], img:null,
    fr:{nom:"LE FONDATEUR DE CROTONE", note:"Une communauté à règle, un silence de cinq ans, et cette thèse : le nombre est la substance des choses."},
    en:{nom:"FOUNDER OF CROTON", note:"A community under rule, a five-year silence, and this thesis: number is the substance of things."} },
...
"029": { debut:-550, fin:-475, approx:true, learn:[21,31,51], stages:[
  ...
  { lvl:21, types:["Philo. Religion"], img:null,
    fr:{nom:"LE CRITIQUE DES DIEUX", note:"Si les bœufs peignaient, leurs dieux auraient des cornes : la théologie devient une projection."},
    en:{nom:"CRITIC OF THE GODS", note:"If oxen could paint, their gods would have horns: theology becomes projection."} },
...
"030": { debut:-515, fin:-475, approx:true, learn:[16,21,26], stages:[
  ...
  { lvl:16, types:["Dialectique","Matérialisme"], img:null,
    fr:{nom:"L'OBSCUR", note:"Un livre déposé au temple d'Artémis, écrit de sorte que seuls les dignes le comprennent."},
    en:{nom:"THE OBSCURE", note:"A book deposited in the temple of Artemis, written so that only the worthy may understand."} },
...
"031": { debut:-495, fin:-460, approx:true, learn:[16,16,21], stages:[
  ...
  { lvl:16, types:["Rationalisme","Idéalisme"], img:null,
    fr:{nom:"LE POÈME DE LA DÉESSE", note:"Un char, des Héliades, et une déesse qui sépare la voie de vérité de la voie de l'opinion."},
    en:{nom:"THE GODDESS'S POEM", note:"A chariot, the Heliades, and a goddess parting the way of truth from the way of opinion."} },
...
"032": { debut:-470, fin:-430, approx:true, learn:[11,16,26], stages:[
  ...
  { lvl:11, types:["Matérialisme"], img:null,
    fr:{nom:"LE PHYSICIEN DES RACINES", note:"Quatre racines éternelles répondent à Parménide : rien ne naît, tout se mélange."},
    en:{nom:"PHYSICIST OF THE ROOTS", note:"Four eternal roots answer Parmenides: nothing is born, everything mixes."} },
...
"033": { debut:-470, fin:-420, approx:true, learn:[21,11,31], stages:[
  ...
  { lvl:11, types:["Scepticisme","Rhétorique"], img:null,
    fr:{nom:"LE PREMIER SOPHISTE", note:"Il ose faire payer son enseignement et promet de rendre le discours faible plus fort."},
    en:{nom:"THE FIRST SOPHIST", note:"He dares charge for his teaching and promises to make the weaker argument the stronger."} },
...
"034": { debut:-440, fin:-370, approx:true, learn:[21,31,51], stages:[
  ...
  { lvl:21, types:["Matérialisme"], img:null,
    fr:{nom:"L'ATOMISTE", note:"Avec Leucippe : rien que des atomes et du vide ; le reste est convention."},
    en:{nom:"THE ATOMIST", note:"With Leucippus: nothing but atoms and void; the rest is convention."} },
...
"035": { debut:-470, fin:-430, approx:true, learn:[16,16,21], stages:[
  ...
  { lvl:16, types:["Logique","Rationalisme"], img:null,
    fr:{nom:"L'INVENTEUR DES PARADOXES", note:"Il ne prouve pas que l'Un existe : il rend le multiple absurde. Aristote y verra la naissance de la dialectique."},
    en:{nom:"INVENTOR OF PARADOXES", note:"He does not prove the One exists: he makes the many absurd. Aristotle will call this the birth of dialectic."} },
...
"036": { debut:-415, fin:-356, approx:true, learn:[21,26,36], stages:[
  ...
  { lvl:21, types:["Hédonisme"], img:null,
    fr:{nom:"LE COURTISAN DE SYRACUSE", note:"À la cour de Denys, il accepte l'humiliation et le luxe avec la même indifférence."},
    en:{nom:"THE COURTIER OF SYRACUSE", note:"At Dionysius's court he accepts humiliation and luxury with equal indifference."} },
...
"037": { debut:-370, fin:-330, approx:true, learn:[11,16,21], stages:[
  { lvl:1,  types:["Logique"], img:null,
    fr:{nom:"LE MÉGARIQUE", note:"Héritier de l'école de Mégare, où l'on discute plus qu'on ne construit."},
    en:{nom:"THE MEGARIAN", note:"Heir to the school of Megara, where more is argued than built."} },
  { lvl:11, types:["Logique"], img:null,
  ...
  { lvl:21, types:["Logique"], img:null,
    fr:{nom:"L'ADVERSAIRE D'ARISTOTE", note:"Il attaque Aristote publiquement ; le vague et l'autoréférence resteront des plaies ouvertes."},
    en:{nom:"ARISTOTLE'S ADVERSARY", note:"He attacks Aristotle publicly; vagueness and self-reference remain open wounds."} },
]},
...
"038": { debut:-340, fin:-270, approx:true, learn:[21,26,36], stages:[
  ...
  { lvl:7,  types:["Scepticisme"], img:null,
    fr:{nom:"LE VOYAGEUR DES INDES", note:"Il suit Alexandre jusqu'aux gymnosophistes, et en revient convaincu que rien ne se laisse trancher."},
    en:{nom:"THE TRAVELLER TO INDIA", note:"He follows Alexander to the gymnosophists, and returns convinced nothing can be settled."} },
...
"039": { debut:-312, fin:-262, approx:true, learn:[16,21,26], stages:[
  ...
  { lvl:12, types:["Stoïcisme"], img:null,
    fr:{nom:"LE MAÎTRE DU PORTIQUE", note:"Il enseigne sous le Portique peint, d'où l'école tire son nom — et non de son fondateur."},
    en:{nom:"MASTER OF THE PORCH", note:"He teaches under the Painted Porch, from which the school takes its name — not from its founder."} },
  { lvl:26, types:["Stoïcisme"], img:null,
...
"040": { debut:-300, fin:-230, approx:true, learn:[21,21,31], stages:[
  { lvl:1,  types:["Scepticisme"], img:null,
    fr:{nom:"LE DANSEUR DE CHŒUR", note:"Orphelin, il gagne sa vie comme danseur avant de rencontrer Pyrrhon à Élis."},
    en:{nom:"THE CHORUS DANCER", note:"Orphaned, he earns his living as a dancer before meeting Pyrrho at Elis."} },
  { lvl:21, types:["Scepticisme"], img:null,
    fr:{nom:"LE DISCIPLE DE PYRRHON", note:"Pyrrhon n'écrivait pas ; sans Timon nous ne saurions rien de lui."},
    en:{nom:"PYRRHO'S DISCIPLE", note:"Pyrrho wrote nothing; without Timon we would know nothing of him."} },
  { lvl:31, types:["Scepticisme"], img:null,
...
"041": { debut:133, fin:180, learn:[38,41,29], stages:[
  ...
  { lvl:29, types:["Stoïcisme"], img:null,
    fr:{nom:"L'EMPEREUR", note:"Rusticus lui prête Épictète ; peste, Danube, révoltes — il gouverne un empire qu'il n'a pas demandé."},
    en:{nom:"THE EMPEROR", note:"Rusticus lends him Epictetus; plague, the Danube, revolts — he rules an empire he never sought."} },
...
"043": { debut:840, fin:877, approx:true, learn:[23,23,12], stages:[
  ...
  { lvl:12, types:["Philo. Religion"], img:null,
    fr:{nom:"LE TRADUCTEUR DU PSEUDO-DENYS", note:"Sa traduction fait entrer la théologie négative grecque dans l'Occident latin."},
    en:{nom:"TRANSLATOR OF PSEUDO-DIONYSIUS", note:"His translation brings Greek negative theology into the Latin West."} },
...
"044": { debut:1059, fin:1109, learn:[20,40,18], stages:[
  ...
  { lvl:18, types:["Philo. Religion","Rationalisme"], img:null,
    fr:{nom:"FIDES QUAERENS INTELLECTUM", note:"Le Monologion prouve Dieu sans citer l'Écriture ; le Proslogion n'a plus besoin que d'une définition."},
    en:{nom:"FIDES QUAERENS INTELLECTUM", note:"The Monologion proves God without citing Scripture; the Proslogion needs only a definition."} },
...
"045": { debut:1309, fin:1347, learn:[11,11,20], stages:[
  ...
  { lvl:11, types:["Logique"], img:null,
    fr:{nom:"LE RASOIR", note:"Ne pas multiplier les entités sans nécessité : les universaux ne sont que des noms."},
    en:{nom:"THE RAZOR", note:"Do not multiply entities beyond necessity: universals are only names."} },
...
"047": { debut:1579, fin:1626, learn:[42,42,27], stages:[
  ...
  { lvl:27, types:["Empirisme","Philo. Sciences"], img:null,
    fr:{nom:"LE CHANCELIER", note:"L'Advancement of Learning inventorie le savoir humain pour montrer tout ce qui manque."},
    en:{nom:"THE CHANCELLOR", note:"The Advancement of Learning inventories human knowledge to show all that is missing."} },
...
"050": { debut:1650, fin:1679, learn:[28,28,24], stages:[
  ...
  { lvl:24, types:["Idéalisme"], img:null,
    fr:{nom:"LA MALADE DE RAGLEY", note:"Des migraines atroces toute sa vie ; van Helmont s'installe chez elle et lui apporte la kabbale."},
    en:{nom:"THE INVALID OF RAGLEY", note:"Excruciating migraines all her life; van Helmont moves in and brings her the Kabbalah."} },
...
"052": { debut:1700, fin:1753, learn:[11,11,14], stages:[
  ...
  { lvl:11, types:["Idéalisme"], img:null,
    fr:{nom:"L'IMMATÉRIALISTE", note:"Être, c'est être perçu : la matière est une hypothèse inutile et, pire, incohérente."},
    en:{nom:"THE IMMATERIALIST", note:"To be is to be perceived: matter is a useless hypothesis and, worse, an incoherent one."} },
...
"053": { debut:1711, fin:1746, learn:[15,15,15], stages:[
  ...
  { lvl:15, types:["Éthique des Vertus","Utilitarisme","Esthétique"], img:null,
    fr:{nom:"LE SENS MORAL", note:"L'Inquiry pose deux sens internes — du beau et du bien — et la formule du plus grand bonheur du plus grand nombre."},
    en:{nom:"THE MORAL SENSE", note:"The Inquiry posits two internal senses — of beauty and of good — and the greatest happiness of the greatest number."} },
...
"054": { debut:1726, fin:1796, learn:[39,60,39], stages:[
  ...
  { lvl:39, types:["Réalisme","Empirisme"], img:null,
    fr:{nom:"L'ADVERSAIRE DE HUME", note:"L'Inquiry refuse la prémisse commune : nous percevons les choses, pas des idées d'elles."},
    en:{nom:"HUME'S ADVERSARY", note:"The Inquiry refuses the shared premise: we perceive things, not ideas of them."} },
...
"057": { debut:1783, fin:1797, learn:[10,5,10], stages:[
  ...
  { lvl:8,  types:["Libéralisme"], img:null,
    fr:{nom:"LA RÉPONSE À BURKE", note:"Première à répliquer aux Réflexions, en trois semaines et anonymement."},
    en:{nom:"THE ANSWER TO BURKE", note:"The first to answer the Reflections, in three weeks and anonymously."} },
...
"058": { debut:1763, fin:1805, learn:[40,40,23], stages:[
  ...
  { lvl:23, types:["Philo. Religion","Utilitarisme"], img:null,
    fr:{nom:"LE MORALISTE THÉOLOGIEN", note:"La vertu, c'est faire le bien du genre humain par obéissance à Dieu et pour le bonheur éternel."},
    en:{nom:"THE THEOLOGICAL MORALIST", note:"Virtue is doing good to mankind in obedience to God and for everlasting happiness."} },
...
"061": { debut:1809, fin:1860, learn:[10,10,10], stages:[
  ...
  { lvl:10, types:["Idéalisme","Mysticisme"], img:"Frankfurt Am Main-Portraits-Arthur Schopenhauer-1845 (cropped).jpg",
    fr:{nom:"LE MONDE COMME VOLONTÉ", note:"Publié à trente ans, invendu ; il programme ses cours à l'heure de ceux de Hegel et parle devant une salle vide."},
    en:{nom:"THE WORLD AS WILL", note:"Published at thirty, unsold; he schedules his lectures opposite Hegel's and speaks to an empty room."} },
  { lvl:43, types:["Idéalisme","Mysticisme"], img:null,
...
"062": { debut:1823, fin:1872, learn:[19,19,40], stages:[
  ...
  { lvl:19, types:["Matérialisme","Humanisme"], img:null,
    fr:{nom:"L'ESSENCE DU CHRISTIANISME", note:"Ce n'est pas Dieu qui fait l'homme : l'homme projette au ciel ce qu'il a de meilleur, et s'en trouve appauvri."},
    en:{nom:"THE ESSENCE OF CHRISTIANITY", note:"God does not make man: man projects his best into heaven, and is impoverished by it."} },
...
"063": { debut:1818, fin:1859, learn:[15,15,15], stages:[
  { lvl:1,  types:["Philo. Droit"], img:null,
    fr:{nom:"L'AVOCAT SANS CLIENTS", note:"Sept ans au barreau pour presque rien ; il vit dans la même rue que Bentham et James Mill."},
    en:{nom:"THE BARRISTER WITHOUT BRIEFS", note:"Seven years at the bar for almost nothing; he lives on the same street as Bentham and James Mill."} },
  { lvl:10, types:["Philo. Droit"], img:null,
    fr:{nom:"LE PROFESSEUR DE JURISPRUDENCE", note:"Première chaire de University College ; ses cours sont si arides que l'auditoire fond."},
    en:{nom:"THE PROFESSOR OF JURISPRUDENCE", note:"The first chair at University College; his lectures are so dry the audience melts away."} },
  { lvl:15, types:["Philo. Droit"], img:null,
...
"070": { debut:1865, fin:1924, learn:[29,19,29], stages:[
  ...
  { lvl:19, types:["Idéalisme","Logique"], img:null,
    fr:{nom:"LE LOGICIEN", note:"Toute relation en appelle une autre pour la relier à ses termes : la régression ne s'arrête jamais."},
    en:{nom:"THE LOGICIAN", note:"Every relation calls for another to bind it to its terms: the regress never halts."} },
...
"071": { debut:1869, fin:1925, learn:[11,24,16], stages:[
  ...
  { lvl:11, types:["Logique"], img:null,
    fr:{nom:"L'IDÉOGRAPHIE", note:"Quatre-vingt-huit pages qui refondent la logique pour la première fois depuis Aristote — et que personne ne lit."},
    en:{nom:"THE CONCEPT-SCRIPT", note:"Eighty-eight pages that recast logic for the first time since Aristotle — and nobody reads them."} },
...
"072": { debut:1873, fin:1912, learn:[30,25,30], stages:[
  ...
  { lvl:20, types:["Philo. Sciences","Rationalisme"], img:null,
    fr:{nom:"LE DERNIER UNIVERSALISTE", note:"Le problème des trois corps lui livre le chaos ; l'invention vient d'un pas sur le marchepied de l'omnibus."},
    en:{nom:"THE LAST UNIVERSALIST", note:"The three-body problem yields him chaos; invention comes as he steps onto an omnibus."} },
...
"076": { debut:1879, fin:1952, learn:[60,38,18], stages:[
  ...
  { lvl:18, types:["Pragmatisme"], img:"John Dewey in 1902.jpg",
    fr:{nom:"L'ÉCOLE-LABORATOIRE", note:"À Chicago, une école où l'on apprend en faisant : la pédagogie devient une épistémologie appliquée."},
    en:{nom:"THE LABORATORY SCHOOL", note:"At Chicago, a school where one learns by doing: pedagogy becomes applied epistemology."} },
  { lvl:38, types:["Pragmatisme"], img:null,
...
"077": { debut:1882, fin:1916, learn:[25,25,25], stages:[
  ...
  { lvl:12, types:["Philo. Sciences","Constructivisme"], img:"Pierre Duhem 1900 (cropped).jpg",
    fr:{nom:"LE PHYSICIEN DE BORDEAUX", note:"Exilé en province, il devient historien des sciences et exhume tout le Moyen Âge scientifique."},
    en:{nom:"THE BORDEAUX PHYSICIST", note:"Exiled to the provinces, he becomes a historian of science and unearths the whole scientific Middle Ages."} },
...
"078": { debut:1882, fin:1952, learn:[15,42,24], stages:[
  ...
  { lvl:15, types:["Esthétique","Humanisme"], img:"George Santayana (1863–1952) c. 1886.png",
    fr:{nom:"LE SENS DE LA BEAUTÉ", note:"La beauté est du plaisir objectivé : elle n'est pas dans la chose, mais elle s'y installe."},
    en:{nom:"THE SENSE OF BEAUTY", note:"Beauty is pleasure objectified: it is not in the thing, yet it settles there."} },
...
"079": { debut:1885, fin:1925, learn:[24,24,37], stages:[
  ...
  { lvl:24, types:["Idéalisme"], img:null,
    fr:{nom:"L'IRRÉALITÉ DU TEMPS", note:"La série A se contredit, la série B ne suffit pas : donc le temps n'existe pas. On en débat encore."},
    en:{nom:"THE UNREALITY OF TIME", note:"The A-series contradicts itself, the B-series does not suffice: therefore time is unreal. The debate continues."} },
...
"080": { debut:1886, fin:1952, learn:[17,17,32], stages:[
  ...
  { lvl:17, types:["Esthétique","Idéalisme"], img:"Benedetto Croce 01 (cropped).jpg",
    fr:{nom:"L'ESTHÉTIQUE", note:"L'art est intuition, et l'intuition est déjà expression : il n'y a pas de contenu qui attende sa forme."},
    en:{nom:"THE AESTHETIC", note:"Art is intuition, and intuition is already expression: no content waits for its form."} },
...
"081": { debut:1902, fin:1964, learn:[13,13,13], stages:[
  ...
  { lvl:9,  types:["Esthétique"], img:"Clive-bell-c-1913.jpg",
    fr:{nom:"L'EXPOSITION POST-IMPRESSIONNISTE", note:"Avec Roger Fry il impose Cézanne à un Londres scandalisé."},
    en:{nom:"THE POST-IMPRESSIONIST SHOW", note:"With Roger Fry he forces Cézanne upon a scandalised London."} },
...
"082": { debut:1900, fin:1973, learn:[35,21,35], stages:[
  ...
  { lvl:21, types:["Philo. Droit"], img:null,
    fr:{nom:"L'ARCHITECTE D'UNE CONSTITUTION", note:"Il rédige celle de l'Autriche et y invente la cour constitutionnelle, dont il sera membre puis chassé."},
    en:{nom:"ARCHITECT OF A CONSTITUTION", note:"He drafts Austria's and invents the constitutional court, of which he is a member and then expelled."} },
...
"083": { debut:1892, fin:1958, learn:[12,34,12], stages:[
  ...
  { lvl:12, types:["Réalisme","Éthique des Vertus"], img:null,
    fr:{nom:"PRINCIPIA ETHICA", note:"Le bien est indéfinissable : toute réduction à un fait naturel laisse la question ouverte."},
    en:{nom:"PRINCIPIA ETHICA", note:"Good is indefinable: any reduction to a natural fact leaves the question open."} },
...
"085": { debut:1902, fin:1944, learn:[33,27,27], stages:[
  ...
  { lvl:18, types:["Philo. Sciences"], img:null,
    fr:{nom:"L'ÉCLIPSE DE PRINCIPE", note:"Objecteur de conscience, il part vérifier la théorie d'un savant du camp ennemi — et la confirme."},
    en:{nom:"THE ECLIPSE OF PRINCIPLE", note:"A conscientious objector, he sails to test an enemy scientist's theory — and confirms it."} },
...
"086": { debut:1920, fin:1930, learn:[7,10,8], stages:[
  ...
  { lvl:7,  types:["Logique","Pragmatisme"], img:null,
    fr:{nom:"LES DEGRÉS DE CROYANCE", note:"La probabilité mesure une confiance, et la cohérence des paris en fixe les règles — la décision bayésienne est née."},
    en:{nom:"DEGREES OF BELIEF", note:"Probability measures confidence, and coherent betting fixes its rules — Bayesian decision theory is born."} },
...
"088": { debut:1906, fin:1943, learn:[25,34,32], stages:[
  ...
  { lvl:25, types:["Logique"], img:null,
    fr:{nom:"LA PREMIÈRE PROFESSEURE", note:"Première femme à occuper une chaire de philosophie au Royaume-Uni ; sa logique fera référence trente ans."},
    en:{nom:"THE FIRST WOMAN PROFESSOR", note:"The first woman to hold a philosophy chair in Britain; her logic remains standard for thirty years."} },
...
"091": { debut:1916, fin:1985, learn:[27,38,38], stages:[
  ...
  { lvl:27, types:["Esthétique"], img:null,
    fr:{nom:"LA NOUVELLE TONALITÉ", note:"Un livre de philosophie devenu best-seller : le symbole n'est pas toujours discursif, la musique le prouve."},
    en:{nom:"THE NEW KEY", note:"A philosophy book turned bestseller: the symbol is not always discursive, and music proves it."} },
...
"092": { debut:1928, fin:1990, learn:[11,21,21], stages:[
  ...
  { lvl:11, types:["Empirisme","Matérialisme"], img:null,
    fr:{nom:"LA BOÎTE", note:"Le renforcement suffit à façonner une conduite ; il n'a besoin d'aucun état mental pour l'expliquer."},
    en:{nom:"THE BOX", note:"Reinforcement suffices to shape conduct; he needs no mental state to explain it."} },
...
"093": { debut:1925, fin:1997, learn:[24,21,34], stages:[
  ...
  { lvl:21, types:["Positivisme"], img:null,
    fr:{nom:"LE CORBEAU", note:"Une chaussure blanche confirme que tous les corbeaux sont noirs : la logique de la confirmation déraille."},
    en:{nom:"THE RAVEN", note:"A white shoe confirms that all ravens are black: the logic of confirmation goes off the rails."} },
...
"097": { debut:1918, fin:1983, learn:[16,16,16], stages:[
  ...
  { lvl:16, types:["Logique","Philo. Langage"], img:null,
    fr:{nom:"LA DÉFINITION DE LA VÉRITÉ", note:"« La neige est blanche » est vrai si et seulement si la neige est blanche — la trivialité devient un théorème."},
    en:{nom:"THE DEFINITION OF TRUTH", note:"\"Snow is white\" is true if and only if snow is white — triviality becomes a theorem."} },
...
"098": { debut:1926, fin:2005, learn:[17,17,57], stages:[
  ...
  { lvl:17, types:["Philo. Sciences"], img:null,
    fr:{nom:"LA SYNTHÈSE MODERNE", note:"L'espèce n'est pas un type mais une population qui n'échange plus ses gènes avec les voisines."},
    en:{nom:"THE MODERN SYNTHESIS", note:"A species is not a type but a population that no longer exchanges genes with its neighbours."} },
...
"099": { debut:1922, fin:1962, learn:[28,36,22], stages:[
  ...
  { lvl:22, types:["Existentialisme","Esthétique"], img:null,
    fr:{nom:"L'EXPÉRIENCE INTÉRIEURE", note:"Une mystique sans Dieu, écrite sous l'Occupation ; Sartre y voit un nouveau mystique et le lui reproche."},
    en:{nom:"INNER EXPERIENCE", note:"A mysticism without God, written under the Occupation; Sartre calls him a new mystic, and means it as a charge."} },
...
"104": { debut:1929, fin:1992, learn:[33,33,33], stages:[
  ...
  { lvl:12, types:["Philo. Droit"], img:null,
    fr:{nom:"L'AGENT DU MI5", note:"La guerre le met au renseignement avec Ryle et Berlin ; il en sort philosophe."},
    en:{nom:"THE MI5 OFFICER", note:"The war puts him in intelligence with Ryle and Berlin; he comes out a philosopher."} },
...
"105": { debut:1929, fin:1989, learn:[8,8,8], stages:[
  ...
  { lvl:8,  types:["Positivisme","Empirisme"], img:null,
    fr:{nom:"LANGAGE, VÉRITÉ ET LOGIQUE", note:"À vingt-six ans il déclare la métaphysique littéralement dépourvue de sens, et devient célèbre du jour au lendemain."},
    en:{nom:"LANGUAGE, TRUTH AND LOGIC", note:"At twenty-six he declares metaphysics literally meaningless, and is famous overnight."} },
...
"106": { debut:1929, fin:1960, learn:[27,27,27], stages:[
  ...
  { lvl:12, types:["Philo. Langage"], img:null,
    fr:{nom:"L'OFFICIER DU RENSEIGNEMENT", note:"Il dirige l'analyse des renseignements du Débarquement ; on lui attribue une part du succès du 6 juin."},
    en:{nom:"THE INTELLIGENCE OFFICER", note:"He runs D-Day intelligence analysis; some of 6 June's success is credited to him."} },
...
"107": { debut:1928, fin:2001, learn:[33,33,33], stages:[
  ...
  { lvl:23, types:["Esthétique"], img:null,
    fr:{nom:"L'HISTOIRE DE L'ART", note:"« Il n'existe pas d'Art, il n'existe que des artistes » — le manuel le plus lu du siècle."},
    en:{nom:"THE STORY OF ART", note:"\"There really is no such thing as Art, there are only artists\" — the century's most-read primer."} },
...
"110": { debut:1930, fin:1994, learn:[34,10,34], stages:[
  ...
  { lvl:10, types:["Éthique des Vertus"], img:"William Frankena, 1978.jpg",
    fr:{nom:"LE SOPHISME DU SOPHISME NATURALISTE", note:"Il montre que l'argument de Moore confond plusieurs erreurs distinctes — et relance tout le débat."},
    en:{nom:"THE NATURALISTIC FALLACY FALLACY", note:"He shows Moore's argument conflates several distinct errors — and reopens the whole debate."} },
  { lvl:34, types:["Éthique des Vertus","Déontologie"], img:null,
...
"111": { debut:1939, fin:1994, learn:[22,22,1], stages:[
  ...
  { lvl:10, types:["Esthétique"], img:null,
    fr:{nom:"LE CRITIQUE DE POLLOCK", note:"Il désigne l'expressionnisme abstrait américain comme la suite légitime de Paris."},
    en:{nom:"POLLOCK'S CRITIC", note:"He anoints American abstract expressionism as the legitimate sequel to Paris."} },
...
"112": { debut:1934, fin:1989, learn:[23,29,23], stages:[
  ...
  { lvl:23, types:["Réalisme","Philo. Esprit"], img:null,
    fr:{nom:"LE MYTHE DU DONNÉ", note:"Rien n'est simplement donné à l'esprit : percevoir, c'est déjà entrer dans l'espace des raisons."},
    en:{nom:"THE MYTH OF THE GIVEN", note:"Nothing is simply given to the mind: to perceive is already to enter the space of reasons."} },
...
"113": { debut:1937, fin:2006, learn:[23,14,23], stages:[
  ...
  { lvl:14, types:["Philo. Langage"], img:null,
    fr:{nom:"LA RÉPONSE À RUSSELL", note:"« Le roi de France est chauve » n'est pas faux : la question ne se pose simplement pas."},
    en:{nom:"THE ANSWER TO RUSSELL", note:"\"The king of France is bald\" is not false: the question simply does not arise."} },
...
"114": { debut:1932, fin:1988, learn:[30,36,36], stages:[
  ...
  { lvl:10, types:["Philo. Langage"], img:null,
    fr:{nom:"L'OFFICIER DE LA ROYAL NAVY", note:"Cinq ans en mer, dont l'Atlantique ; il en revient au groupe du samedi matin d'Austin."},
    en:{nom:"THE ROYAL NAVY OFFICER", note:"Five years at sea, including the Atlantic; he returns to Austin's Saturday morning group."} },
...
"115": { debut:1937, fin:1996, learn:[38,38,23], stages:[
  ...
  { lvl:23, types:["Philo. Sciences"], img:null,
    fr:{nom:"LA TRIANGULATION", note:"Aucune mesure isolée n'est fiable ; seule la convergence de méthodes indépendantes fait preuve."},
    en:{nom:"TRIANGULATION", note:"No single measure is reliable; only convergence of independent methods counts as evidence."} },
...
"116": { debut:1936, fin:1985, learn:[11,23,23], stages:[
  ...
  { lvl:11, types:["Esthétique"], img:null,
    fr:{nom:"L'ERREUR INTENTIONNELLE", note:"Avec Wimsatt : ce que l'auteur voulait dire n'est ni disponible ni pertinent pour juger l'œuvre."},
    en:{nom:"THE INTENTIONAL FALLACY", note:"With Wimsatt: what the author meant is neither available nor relevant to judging the work."} },
  { lvl:23, types:["Esthétique"], img:null,
...
"117": { debut:1938, fin:1981, learn:[19,19,19], stages:[
  { lvl:1,  types:["Esthétique"], img:null,
    fr:{nom:"L'ÉTUDIANT DE DETROIT", note:"Wayne State puis l'armée ; il revient à la philosophie par la théorie littéraire."},
    en:{nom:"THE DETROIT STUDENT", note:"Wayne State then the army; he returns to philosophy by way of literary theory."} },
  { lvl:19, types:["Esthétique"], img:null,
  ...
  { lvl:27, types:["Esthétique"], img:null,
    fr:{nom:"LE LECTEUR DE WITTGENSTEIN", note:"Les ressemblances de famille suffisent : on reconnaît l'art sans pouvoir le définir."},
    en:{nom:"THE READER OF WITTGENSTEIN", note:"Family resemblances suffice: we recognise art without being able to define it."} },
]},
...
"119": { debut:1934, fin:2013, learn:[29,29,24], stages:[
  ...
  { lvl:24, types:["Logique"], img:null,
    fr:{nom:"LES ACTES MENTAUX", note:"Contre l'abstractionnisme : on n'acquiert pas les concepts en dépouillant les images."},
    en:{nom:"MENTAL ACTS", note:"Against abstractionism: concepts are not acquired by stripping down images."} },
...
"120": { debut:1937, fin:2001, learn:[22,21,21], stages:[
  ...
  { lvl:10, types:["Philo. Esprit"], img:null,
    fr:{nom:"L'EXÉCUTRICE LITTÉRAIRE", note:"Wittgenstein la choisit pour traduire et éditer ses inédits ; elle apprend l'allemand pour cela."},
    en:{nom:"THE LITERARY EXECUTOR", note:"Wittgenstein chooses her to translate and edit his papers; she learns German for it."} },
...
"121": { debut:1946, fin:1997, learn:[13,19,13], stages:[
  ...
  { lvl:13, types:["Philo. Langage","Philo. Sciences"], img:null,
    fr:{nom:"L'IDÉE D'UNE SCIENCE SOCIALE", note:"Comprendre une société, c'est apprendre ses règles — pas découvrir ses lois causales."},
    en:{nom:"THE IDEA OF A SOCIAL SCIENCE", note:"To understand a society is to learn its rules — not to discover its causal laws."} },
...
"122": { debut:1935, fin:2003, learn:[36,39,48], stages:[
  ...
  { lvl:29, types:["Philo. Esprit"], img:null,
    fr:{nom:"LES RAISONS SONT DES CAUSES", note:"Contre tout Oxford : expliquer une action par une raison, c'est bien l'expliquer causalement."},
    en:{nom:"REASONS ARE CAUSES", note:"Against all of Oxford: to explain an action by a reason is indeed to explain it causally."} },
...
"123": { debut:1932, fin:1991, learn:[30,30,46], stages:[
  ...
  { lvl:30, types:["Philo. Esprit"], img:null,
    fr:{nom:"L'ACTION LIBRE", note:"Lever le bras n'est pas un mouvement plus une volition : l'action ne se décompose pas ainsi."},
    en:{nom:"FREE ACTION", note:"Raising one's arm is not a movement plus a volition: action does not decompose that way."} },
...
"124": { debut:1946, fin:2012, learn:[14,28,20], stages:[
  ...
  { lvl:14, types:["Philo. Esprit","Réalisme"], img:null,
    fr:{nom:"LA THÉORIE DE L'IDENTITÉ", note:"Les sensations ne sont pas corrélées aux processus cérébraux : elles sont ces processus."},
    en:{nom:"THE IDENTITY THEORY", note:"Sensations are not correlated with brain processes: they are those processes."} },
...
"125": { debut:1937, fin:2002, learn:[16,27,45], stages:[
  ...
  { lvl:16, types:["Déontologie"], img:null,
    fr:{nom:"LE PRESCRIPTIVISME", note:"Un jugement moral est un impératif universalisable : il m'engage partout où le cas se répète."},
    en:{nom:"PRESCRIPTIVISM", note:"A moral judgement is a universalisable imperative: it binds me wherever the case recurs."} },
...
"126": { debut:1935, fin:1981, learn:[43,43,43], stages:[
  ...
  { lvl:21, types:["Scepticisme"], img:null,
    fr:{nom:"LE PROBLÈME DU MAL", note:"Il reformule l'argument logique contre l'existence de Dieu avec une rigueur qui oblige à répondre."},
    en:{nom:"THE PROBLEM OF EVIL", note:"He restates the logical argument against God's existence with a rigour that demands an answer."} },
...
"127": { debut:1939, fin:2010, learn:[63,29,34], stages:[
  ...
  { lvl:29, types:["Éthique des Vertus","Déontologie"], img:null,
    fr:{nom:"LE TRAMWAY", note:"Un cas inventé au passage dans un article sur l'avortement devient l'expérience de pensée du siècle."},
    en:{nom:"THE TROLLEY", note:"A case invented in passing in a paper on abortion becomes the century's thought experiment."} },
...
"128": { debut:1946, fin:1996, learn:[14,14,20], stages:[
  { lvl:1,  types:["Esthétique"], img:null,
    fr:{nom:"L'ÉTUDIANT DE READING", note:"Formé en Angleterre et aux États-Unis, il choisit un domaine que l'analyse jugeait indigne."},
    en:{nom:"THE READING STUDENT", note:"Trained in England and America, he picks a field analysis deemed unworthy."} },
  { lvl:14, types:["Esthétique"], img:null,
  ...
  { lvl:20, types:["Esthétique"], img:null,
    fr:{nom:"LE GOÛT SANS RÈGLE", note:"Il faut du goût pour les employer — un discernement qui s'exerce mais ne se code pas."},
    en:{nom:"TASTE WITHOUT RULES", note:"Taste is required to use them — a discernment that is exercised but not codified."} },
]},
...
"134": { debut:1950, fin:1998, learn:[30,34,30], stages:[
  ...
  { lvl:30, types:["Postmodernisme"], img:null,
    fr:{nom:"LA FIN DES GRANDS RÉCITS", note:"Un rapport commandé par le Québec devient le diagnostic d'une époque : plus personne ne croit aux histoires totales."},
    en:{nom:"THE END OF GRAND NARRATIVES", note:"A report commissioned by Quebec becomes an age's diagnosis: no one believes total stories any more."} },
...
"137": { debut:1949, fin:2020, learn:[26,26,32], stages:[
  { lvl:1,  types:["Esthétique"], img:null,
    fr:{nom:"L'ÉTUDIANT DE LOS ANGELES", note:"UCLA après la guerre ; il consacrera sa carrière à définir ce que Weitz jugeait indéfinissable."},
    en:{nom:"THE LOS ANGELES STUDENT", note:"UCLA after the war; he devotes his career to defining what Weitz called undefinable."} },
  { lvl:26, types:["Esthétique"], img:null,
  ...
  { lvl:32, types:["Esthétique"], img:null,
    fr:{nom:"L'APPRÉCIATION SANS CONDITION", note:"Il révise sa définition contre ses critiques : le cercle est réel, mais il n'est pas vicieux."},
    en:{nom:"APPRECIATION WITHOUT CONDITION", note:"He revises his definition against his critics: the circle is real, but not vicious."} },
]},
...
"138": { debut:1944, fin:2011, learn:[30,34,30], stages:[
  ...
  { lvl:30, types:["Logique","Philo. Langage"], img:null,
    fr:{nom:"L'ANTI-RÉALISME SÉMANTIQUE", note:"Comprendre une phrase, c'est savoir la vérifier ; ce qu'on ne peut établir n'a pas de valeur de vérité d'avance."},
    en:{nom:"SEMANTIC ANTI-REALISM", note:"To understand a sentence is to know how to verify it; what cannot be settled has no truth-value in advance."} },
...
"140": { debut:1949, fin:2021, learn:[15,15,20], stages:[
  { lvl:1,  types:["Scepticisme"], img:null,
    fr:{nom:"L'ÉLÈVE DE CORNELL", note:"Formé par Malcolm et Rescher ; il publiera trois pages en tout et deviendra célèbre."},
    en:{nom:"THE CORNELL STUDENT", note:"Trained by Malcolm and Rescher; he will publish three pages in all and become famous."} },
  { lvl:15, types:["Scepticisme","Empirisme"], img:null,
  ...
  { lvl:20, types:["Scepticisme","Empirisme"], img:null,
    fr:{nom:"LE SILENCE D'APRÈS", note:"Il ne publiera plus rien de sa vie, et enseignera la logique modale pendant quarante ans."},
    en:{nom:"THE SILENCE AFTER", note:"He never publishes again, and teaches modal logic for forty years."} },
]},
...
"141": { debut:1945, fin:null, learn:[13,15,44], stages:[
  ...
  { lvl:13, types:["Philo. Langage","Philo. Esprit"], img:null,
    fr:{nom:"LA GRAMMAIRE GÉNÉRATIVE", note:"Un enfant produit des phrases jamais entendues : la langue ne s'apprend pas par renforcement."},
    en:{nom:"GENERATIVE GRAMMAR", note:"A child produces sentences never heard: language is not learned by reinforcement."} },
...
"142": { debut:1956, fin:2007, learn:[26,26,32], stages:[
  ...
  { lvl:13, types:["Postmodernisme"], img:null,
    fr:{nom:"LE SYSTÈME DES OBJETS", note:"On ne consomme pas des choses mais des signes : l'objet vaut par sa place dans un code."},
    en:{nom:"THE SYSTEM OF OBJECTS", note:"We consume not things but signs: an object's worth is its place in a code."} },
...
"143": { debut:1951, fin:2021, learn:[29,50,41], stages:[
  ...
  { lvl:29, types:["Philo. Sciences"], img:null,
    fr:{nom:"LES TYMPANS DE SAN MARCO", note:"Avec Gould : tout trait n'est pas une adaptation ; certains ne sont que des sous-produits d'architecture."},
    en:{nom:"THE SPANDRELS OF SAN MARCO", note:"With Gould: not every trait is an adaptation; some are mere by-products of architecture."} },
...
"144": { debut:1949, fin:2023, learn:[23,23,38], stages:[
  ...
  { lvl:21, types:["Philo. Esprit"], img:null,
    fr:{nom:"LES CAS DE FRANKFURT", note:"Un homme responsable de son acte alors qu'il ne pouvait pas faire autrement : le principe des possibilités alternatives tombe."},
    en:{nom:"FRANKFURT CASES", note:"A man responsible for an act he could not have avoided: the principle of alternate possibilities falls."} },
...
"145": { debut:1948, fin:2003, learn:[26,26,38], stages:[
  ...
  { lvl:26, types:["Éthique des Vertus"], img:null,
    fr:{nom:"L'INTÉGRITÉ CONTRE L'UTILITARISME", note:"Une morale qui exige qu'on abandonne ses propres projets détruit la personne qu'elle prétend guider."},
    en:{nom:"INTEGRITY AGAINST UTILITARIANISM", note:"A morality demanding one abandon one's own projects destroys the person it claims to guide."} },
...
"146": { debut:1950, fin:2020, learn:[22,41,36], stages:[
  ...
  { lvl:22, types:["Déontologie"], img:null,
    fr:{nom:"LE VIOLONISTE", note:"Vous réveiller branché à un violoniste célèbre : même si sa vie compte, elle ne vous oblige pas à rester."},
    en:{nom:"THE VIOLINIST", note:"Waking up plugged into a famous violinist: even if his life matters, it does not oblige you to stay."} },
...
"148": { debut:1954, fin:null, learn:[21,21,30], stages:[
  ...
  { lvl:21, types:["Philo. Religion","Logique"], img:null,
    fr:{nom:"LA DÉFENSE PAR LE LIBRE ARBITRE", note:"Il montre qu'un Dieu bon et le mal ne sont pas logiquement incompatibles — Mackie le concédera."},
    en:{nom:"THE FREE WILL DEFENCE", note:"He shows a good God and evil are not logically incompatible — Mackie concedes the point."} },
...
"149": { debut:1955, fin:null, learn:[20,23,23], stages:[
  ...
  { lvl:20, types:["Féminisme","Phénoménologie"], img:null,
    fr:{nom:"SPECULUM", note:"Sa thèse lui coûte son poste et son exclusion de l'École freudienne : la psychanalyse a un sexe."},
    en:{nom:"SPECULUM", note:"Her thesis costs her post and expulsion from Lacan's school: psychoanalysis has a sex."} },
...
"155": { debut:1956, fin:2025, learn:[31,36,36], stages:[
  ...
  { lvl:31, types:["Féminisme","Philo. Sciences"], img:null,
    fr:{nom:"LA QUESTION DE LA SCIENCE", note:"La neutralité proclamée cache un point de vue ; on ne l'annule pas en le niant."},
    en:{nom:"THE SCIENCE QUESTION", note:"Proclaimed neutrality hides a standpoint; denying it does not cancel it."} },
...
"156": { debut:1958, fin:null, learn:[25,25,25], stages:[
  ...
  { lvl:25, types:["Éthique du Soin","Féminisme"], img:null,
    fr:{nom:"UNE VOIX DIFFÉRENTE", note:"Elles ne raisonnent pas moins bien : elles raisonnent en relations plutôt qu'en principes."},
    en:{nom:"IN A DIFFERENT VOICE", note:"They do not reason worse: they reason in relationships rather than in principles."} },
...
"157": { debut:1957, fin:2010, learn:[22,32,32], stages:[
  ...
  { lvl:22, types:["Philo. Sciences"], img:null,
    fr:{nom:"LES ESPÈCES SONT DES INDIVIDUS", note:"Une espèce n'est pas une classe mais un individu étendu dans le temps — elle naît et elle meurt."},
    en:{nom:"SPECIES ARE INDIVIDUALS", note:"A species is not a class but an individual extended in time — it is born and it dies."} },
...
"158": { debut:1960, fin:2024, learn:[20,8,40], stages:[
  ...
  { lvl:8,  types:["Empirisme"], img:null,
    fr:{nom:"LA THÉORIE CAUSALE", note:"Réponse à Gettier : savoir, c'est que le fait ait causé la croyance par la bonne voie."},
    en:{nom:"THE CAUSAL THEORY", note:"An answer to Gettier: knowing means the fact caused the belief along the right path."} },
...
"159": { debut:1960, fin:null, learn:[34,34,23], stages:[
  ...
  { lvl:23, types:["Réalisme","Métaphysique"], img:null,
    fr:{nom:"LA PERMANENCE DES OBJETS", note:"Ce qui fait qu'un objet reste le même dépend du concept sous lequel on le suit."},
    en:{nom:"THE PERSISTENCE OF OBJECTS", note:"What makes an object stay the same depends on the concept under which we track it."} },
...
"162": { debut:1962, fin:2022, learn:[20,16,20], stages:[
  ...
  { lvl:16, types:["Philo. Sciences"], img:null,
    fr:{nom:"LE PROGRÈS ET SES PROBLÈMES", note:"Une théorie ne progresse pas en accumulant du vrai mais en résolvant plus de problèmes qu'elle n'en crée."},
    en:{nom:"PROGRESS AND ITS PROBLEMS", note:"A theory progresses not by accumulating truth but by solving more problems than it creates."} },
...
"163": { debut:1963, fin:null, learn:[18,18,18], stages:[
  ...
  { lvl:18, types:["Philo. Sciences","Scepticisme"], img:null,
    fr:{nom:"L'EMPIRISME CONSTRUCTIF", note:"Accepter une théorie, ce n'est pas la croire vraie : c'est la croire empiriquement adéquate, et s'en contenter."},
    en:{nom:"CONSTRUCTIVE EMPIRICISM", note:"Accepting a theory is not believing it true: it is believing it empirically adequate, and resting there."} },
...
"166": { debut:1963, fin:2021, learn:[18,18,25], stages:[
  { lvl:1,  types:["Philo. Sciences"], img:null,
    fr:{nom:"LE LOGICIEN DU MIT", note:"Formé à la logique et à la philosophie des sciences, il enseignera quarante ans à Cornell."},
    en:{nom:"THE MIT LOGICIAN", note:"Trained in logic and philosophy of science, he teaches forty years at Cornell."} },
  ...
  { lvl:25, types:["Philo. Sciences","Réalisme"], img:null,
    fr:{nom:"LES ESPÈCES NATURELLES", note:"Une espèce est un faisceau de propriétés qui tiennent ensemble : la nature a des jointures, mais floues."},
    en:{nom:"NATURAL KINDS", note:"A kind is a cluster of properties that hold together: nature has joints, but blurred ones."} },
]},
...
"167": { debut:1963, fin:null, learn:[32,32,32], stages:[
  ...
  { lvl:15, types:["Philo. Esprit"], img:null,
    fr:{nom:"LE COMMENTATEUR DU THÉÉTÈTE", note:"Une traduction commentée de Platon qui fait autorité avant qu'il ne publie sa propre philosophie."},
    en:{nom:"THE THEAETETUS COMMENTATOR", note:"An authoritative translation of Plato before he publishes any philosophy of his own."} },
...
"168": { debut:1962, fin:null, learn:[21,37,37], stages:[
  ...
  { lvl:21, types:["Contractualisme","Déontologie"], img:null,
    fr:{nom:"LE REJET RAISONNABLE", note:"Un acte est mal s'il viole un principe que nul ne pourrait raisonnablement rejeter."},
    en:{nom:"REASONABLE REJECTION", note:"An act is wrong if it violates a principle no one could reasonably reject."} },
...
"170": { debut:1959, fin:null, learn:[18,18,28], stages:[
  ...
  { lvl:18, types:["Philo. Sciences","Matérialisme"], img:null,
    fr:{nom:"LE GÈNE ÉGOÏSTE", note:"L'organisme est le véhicule, le gène est le passager : renverser la perspective change tout le tableau."},
    en:{nom:"THE SELFISH GENE", note:"The organism is the vehicle, the gene the passenger: reversing the perspective changes the whole picture."} },
...
"173": { debut:1964, fin:null, learn:[16,16,23], stages:[
  ...
  { lvl:16, types:["Philo. Esprit","Matérialisme"], img:null,
    fr:{nom:"LE MATÉRIALISME ÉLIMINATIF", note:"Croyances et désirs sont les phlogistiques de la psychologie : la neuroscience ne les réduira pas, elle les supprimera."},
    en:{nom:"ELIMINATIVE MATERIALISM", note:"Beliefs and desires are psychology's phlogiston: neuroscience will not reduce them, it will delete them."} },
...
"174": { debut:1964, fin:null, learn:[32,15,32], stages:[
  ...
  { lvl:15, types:["Philo. Esprit"], img:null,
    fr:{nom:"LA NATION CHINOISE", note:"Si un milliard de Chinois simulaient un cerveau une heure durant, ressentiraient-ils quelque chose ?"},
    en:{nom:"THE CHINESE NATION", note:"If a billion Chinese simulated a brain for an hour, would anything be felt?"} },
...
"175": { debut:1966, fin:null, learn:[18,18,34], stages:[
  ...
  { lvl:18, types:["Philo. Sciences","Réalisme"], img:null,
    fr:{nom:"LES LOIS MENTENT", note:"Les lois fondamentales sont vraies uniquement dans des modèles idéalisés ; ce sont les capacités qui existent."},
    en:{nom:"THE LAWS LIE", note:"Fundamental laws hold only in idealised models; it is capacities that exist."} },
...
"176": { debut:1962, fin:null, learn:[23,23,37], stages:[
  ...
  { lvl:23, types:["Réalisme","Éthique des Vertus"], img:null,
    fr:{nom:"LE QUASI-RÉALISME", note:"Nos jugements moraux ne décrivent rien, et pourtant on peut leur rendre tous les droits du vrai."},
    en:{nom:"QUASI-REALISM", note:"Our moral judgements describe nothing, and yet all the rights of truth can be earned back for them."} },
...
"178": { debut:1966, fin:null, learn:[28,28,38], stages:[
  ...
  { lvl:28, types:["Pragmatisme","Empirisme"], img:null,
    fr:{nom:"LE FONDHÉRENTISME", note:"Ni fondation ni pure cohérence : la justification ressemble à une grille de mots croisés."},
    en:{nom:"FOUNDHERENTISM", note:"Neither foundation nor bare coherence: justification is like a crossword puzzle."} },
...
"180": { debut:1968, fin:null, learn:[22,22,30], stages:[
  { lvl:1,  types:["Philo. Sciences"], img:null,
    fr:{nom:"L'ÉLÈVE DE LAKATOS", note:"Formé à la LSE dans le sillage des programmes de recherche, il y enseignera toute sa carrière."},
    en:{nom:"LAKATOS'S STUDENT", note:"Trained at the LSE in the wake of research programmes, he teaches there his whole career."} },
  { lvl:22, types:["Philo. Sciences"], img:null,
  ...
  { lvl:30, types:["Philo. Sciences"], img:null,
    fr:{nom:"LE MEILLEUR DES DEUX MONDES", note:"Une position qui garde le non-miracle sans encaisser la méta-induction pessimiste."},
    en:{nom:"THE BEST OF BOTH WORLDS", note:"A position that keeps the no-miracles argument without taking the pessimistic meta-induction."} },
]},
...
"182": { debut:1968, fin:null, learn:[20,20,28], stages:[
  ...
  { lvl:20, types:["Logique"], img:null,
    fr:{nom:"LE DIALÉTHÉISME", note:"Certaines contradictions sont vraies ; il suffit d'une logique qui n'explose pas pour le supporter."},
    en:{nom:"DIALETHEISM", note:"Some contradictions are true; one need only a logic that does not explode to bear it."} },
...
"184": { debut:1974, fin:null, learn:[17,20,17], stages:[
  ...
  { lvl:17, types:["Féminisme","Postmodernisme"], img:null,
    fr:{nom:"TROUBLE DANS LE GENRE", note:"Le genre n'exprime pas une identité préalable : il se fabrique par la répétition des actes qui le citent."},
    en:{nom:"GENDER TROUBLE", note:"Gender expresses no prior identity: it is made by the repetition of acts that cite it."} },
...
"186": { debut:1980, fin:null, learn:[16,16,27], stages:[
  ...
  { lvl:16, types:["Philo. Religion","Logique"], img:null,
    fr:{nom:"LES ARGUMENTS ONTOLOGIQUES", note:"À chaque preuve de Dieu correspond une parodie de même forme ; c'est cette symétrie qui les tue."},
    en:{nom:"ONTOLOGICAL ARGUMENTS", note:"Every proof of God has a parody of the same form; that symmetry is what kills them."} },
...
"187": { debut:1977, fin:null, learn:[22,22,27], stages:[
  ...
  { lvl:22, types:["Philo. Esprit","Philo. Technique"], img:null,
    fr:{nom:"LE CARNET D'OTTO", note:"Avec Chalmers : si le carnet joue le rôle de la mémoire, il fait partie de l'esprit."},
    en:{nom:"OTTO'S NOTEBOOK", note:"With Chalmers: if the notebook plays memory's role, it is part of the mind."} },
...
"188": { debut:1986, fin:null, learn:[10,11,11], stages:[
  ...
  { lvl:10, types:["Philo. Esprit","Dualisme"], img:null,
    fr:{nom:"LE PROBLÈME DIFFICILE", note:"Expliquer les fonctions ne dit toujours pas pourquoi il y a quelque chose que cela fait ; le nom reste."},
    en:{nom:"THE HARD PROBLEM", note:"Explaining the functions still does not say why there is something it is like; the name sticks."} },
...
"189": { debut:1990, fin:null, learn:[18,18,18], stages:[
  ...
  { lvl:9,  types:["Philo. Sciences"], img:null,
    fr:{nom:"LA VERSION ONTIQUE", note:"Non pas : nous ne connaissons que les structures ; mais : il n'y a que des structures."},
    en:{nom:"THE ONTIC VERSION", note:"Not: we know only structures; but: there are only structures."} },
  { lvl:18, types:["Philo. Sciences","Réalisme"], img:null,
